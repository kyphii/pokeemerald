...
#define WOHNET_TO_NATIONAL(name)     [WOHNET_DEX_##name - 1] = NATIONAL_DEX_##name

static const enum NationalDexOrder sWohnetToNationalOrder[WOHNET_DEX_COUNT] =
{
    WOHNET_TO_NATIONAL(TURTWIG),
    WOHNET_TO_NATIONAL(GROTLE),
    WOHNET_TO_NATIONAL(TORTERRA),
    WOHNET_TO_NATIONAL(FENNEKIN),
    WOHNET_TO_NATIONAL(BRAIXEN),
    WOHNET_TO_NATIONAL(DELPHOX),
    WOHNET_TO_NATIONAL(POPPLIO),
    WOHNET_TO_NATIONAL(BRIONNE),
    WOHNET_TO_NATIONAL(PRIMARINA),
    WOHNET_TO_NATIONAL(LEDYBA),
    WOHNET_TO_NATIONAL(LEDIAN),
    WOHNET_TO_NATIONAL(KRICKETOT),
    WOHNET_TO_NATIONAL(KRICKETUNE),
    WOHNET_TO_NATIONAL(WURMPLE),
    WOHNET_TO_NATIONAL(SILCOON),
    WOHNET_TO_NATIONAL(BEAUTIFLY),
    WOHNET_TO_NATIONAL(CASCOON),
    WOHNET_TO_NATIONAL(DUSTOX),
    WOHNET_TO_NATIONAL(TAILLOW),
    WOHNET_TO_NATIONAL(SWELLOW),
    WOHNET_TO_NATIONAL(PIDOVE),
    WOHNET_TO_NATIONAL(TRANQUILL),
    WOHNET_TO_NATIONAL(UNFEZANT),
    WOHNET_TO_NATIONAL(SENTRET),
    WOHNET_TO_NATIONAL(FURRET),
    WOHNET_TO_NATIONAL(SKITTY),
    WOHNET_TO_NATIONAL(DELCATTY),
    WOHNET_TO_NATIONAL(PICHU),
    WOHNET_TO_NATIONAL(PIKACHU),
    WOHNET_TO_NATIONAL(RAICHU),
    WOHNET_TO_NATIONAL(HOOTHOOT),
    WOHNET_TO_NATIONAL(NOCTOWL),
    WOHNET_TO_NATIONAL(MURKROW),
    WOHNET_TO_NATIONAL(HONCHKROW),
    WOHNET_TO_NATIONAL(SKWOVET),
    WOHNET_TO_NATIONAL(GREEDENT),
    WOHNET_TO_NATIONAL(BUNEARY),
    WOHNET_TO_NATIONAL(LOPUNNY),
    WOHNET_TO_NATIONAL(PACHIRISU),
    WOHNET_TO_NATIONAL(EKANS),
    WOHNET_TO_NATIONAL(ARBOK),
    WOHNET_TO_NATIONAL(STUNKY),
    WOHNET_TO_NATIONAL(SKUNTANK),
    WOHNET_TO_NATIONAL(SEEDOT),
    WOHNET_TO_NATIONAL(NUZLEAF),
    WOHNET_TO_NATIONAL(SHIFTRY),
    WOHNET_TO_NATIONAL(NICKIT),
    WOHNET_TO_NATIONAL(THIEVUL),
    WOHNET_TO_NATIONAL(SCYTHER),
    WOHNET_TO_NATIONAL(SCIZOR),
    WOHNET_TO_NATIONAL(PINSIR),
    WOHNET_TO_NATIONAL(SEWADDLE),
    WOHNET_TO_NATIONAL(SWADLOON),
    WOHNET_TO_NATIONAL(LEAVANNY),
    WOHNET_TO_NATIONAL(VENIPEDE),
    WOHNET_TO_NATIONAL(WHIRLIPEDE),
    WOHNET_TO_NATIONAL(SCOLIPEDE),
    WOHNET_TO_NATIONAL(SHELMET),
    WOHNET_TO_NATIONAL(ACCELGOR),
    WOHNET_TO_NATIONAL(KARRABLAST),
    WOHNET_TO_NATIONAL(ESCAVALIER),
    WOHNET_TO_NATIONAL(SHROOMISH),
    WOHNET_TO_NATIONAL(BRELOOM),
    WOHNET_TO_NATIONAL(DEERLING),
    WOHNET_TO_NATIONAL(SAWSBUCK),
    WOHNET_TO_NATIONAL(PUMPKABOO),
    WOHNET_TO_NATIONAL(GOURGEIST),
    WOHNET_TO_NATIONAL(MUNCHLAX),
    WOHNET_TO_NATIONAL(SNORLAX),
    WOHNET_TO_NATIONAL(AIPOM),
    WOHNET_TO_NATIONAL(AMBIPOM),
    WOHNET_TO_NATIONAL(STUFFUL),
    WOHNET_TO_NATIONAL(BEWEAR),
    WOHNET_TO_NATIONAL(DROWZEE),
    WOHNET_TO_NATIONAL(HYPNO),
    WOHNET_TO_NATIONAL(HERACROSS),
    WOHNET_TO_NATIONAL(MISDREAVUS),
    WOHNET_TO_NATIONAL(MISMAGIUS),
    WOHNET_TO_NATIONAL(ABSOL),
    WOHNET_TO_NATIONAL(IMPIDIMP),
    WOHNET_TO_NATIONAL(MORGREM),
    WOHNET_TO_NATIONAL(GRIMMSNARL),
    WOHNET_TO_NATIONAL(SPEAROW),
    WOHNET_TO_NATIONAL(FEAROW),
    WOHNET_TO_NATIONAL(SWABLU),
    WOHNET_TO_NATIONAL(ALTARIA),
    WOHNET_TO_NATIONAL(SNUBBULL),
    WOHNET_TO_NATIONAL(GRANBULL),
    WOHNET_TO_NATIONAL(TEDDIURSA),
    WOHNET_TO_NATIONAL(URSARING),
    WOHNET_TO_NATIONAL(URSALUNA),
    WOHNET_TO_NATIONAL(PURRLOIN),
    WOHNET_TO_NATIONAL(LIEPARD),
    WOHNET_TO_NATIONAL(ELEKID),
    WOHNET_TO_NATIONAL(ELECTABUZZ),
    WOHNET_TO_NATIONAL(ELECTIVIRE),
    WOHNET_TO_NATIONAL(MAGBY),
    WOHNET_TO_NATIONAL(MAGMAR),
    WOHNET_TO_NATIONAL(MAGMORTAR),
    WOHNET_TO_NATIONAL(TYROGUE),
    WOHNET_TO_NATIONAL(HITMONLEE),
    WOHNET_TO_NATIONAL(HITMONCHAN),
    WOHNET_TO_NATIONAL(HITMONTOP),
    WOHNET_TO_NATIONAL(NATU),
    WOHNET_TO_NATIONAL(XATU),
    WOHNET_TO_NATIONAL(NIDORAN_F),
    WOHNET_TO_NATIONAL(NIDORINA),
    WOHNET_TO_NATIONAL(NIDOQUEEN),
    WOHNET_TO_NATIONAL(NIDORAN_M),
    WOHNET_TO_NATIONAL(NIDORINO),
    WOHNET_TO_NATIONAL(NIDOKING),
    WOHNET_TO_NATIONAL(RHYHORN),
    WOHNET_TO_NATIONAL(RHYDON),
    WOHNET_TO_NATIONAL(RHYPERIOR),
    WOHNET_TO_NATIONAL(BONSLY),
    WOHNET_TO_NATIONAL(SUDOWOODO),
    WOHNET_TO_NATIONAL(MIENFOO),
    WOHNET_TO_NATIONAL(MIENSHAO),
    WOHNET_TO_NATIONAL(HOUNDOUR),
    WOHNET_TO_NATIONAL(HOUNDOOM),
    WOHNET_TO_NATIONAL(DURANT),
    WOHNET_TO_NATIONAL(HEATMOR),
    WOHNET_TO_NATIONAL(SKARMORY),
    WOHNET_TO_NATIONAL(TINKATINK),
    WOHNET_TO_NATIONAL(TINKATUFF),
    WOHNET_TO_NATIONAL(TINKATON),
    WOHNET_TO_NATIONAL(SWINUB),
    WOHNET_TO_NATIONAL(PILOSWINE),
    WOHNET_TO_NATIONAL(MAMOSWINE),
    WOHNET_TO_NATIONAL(SNEASEL),
    WOHNET_TO_NATIONAL(WEAVILE),
    WOHNET_TO_NATIONAL(SNORUNT),
    WOHNET_TO_NATIONAL(GLALIE),
    WOHNET_TO_NATIONAL(FROSLASS),
    WOHNET_TO_NATIONAL(SNOVER),
    WOHNET_TO_NATIONAL(ABOMASNOW),
    WOHNET_TO_NATIONAL(CRYOGONAL),
    WOHNET_TO_NATIONAL(SNOM),
    WOHNET_TO_NATIONAL(FROSMOTH),
    WOHNET_TO_NATIONAL(CETODDLE),
    WOHNET_TO_NATIONAL(CETITAN),
    WOHNET_TO_NATIONAL(MEDITITE),
    WOHNET_TO_NATIONAL(MEDICHAM),
    WOHNET_TO_NATIONAL(HOPPIP),
    WOHNET_TO_NATIONAL(SKIPLOOM),
    WOHNET_TO_NATIONAL(JUMPLUFF),
    WOHNET_TO_NATIONAL(WYNAUT),
    WOHNET_TO_NATIONAL(WOBBUFFET),
    WOHNET_TO_NATIONAL(CHINGLING),
    WOHNET_TO_NATIONAL(CHIMECHO),
    WOHNET_TO_NATIONAL(GOTHITA),
    WOHNET_TO_NATIONAL(GOTHORITA),
    WOHNET_TO_NATIONAL(GOTHITELLE),
    WOHNET_TO_NATIONAL(SOLOSIS),
    WOHNET_TO_NATIONAL(DUOSION),
    WOHNET_TO_NATIONAL(REUNICLUS),
    WOHNET_TO_NATIONAL(DRIFLOON),
    WOHNET_TO_NATIONAL(DRIFBLIM),
    WOHNET_TO_NATIONAL(APPLIN),
    WOHNET_TO_NATIONAL(FLAPPLE),
    WOHNET_TO_NATIONAL(APPLETUN),
    WOHNET_TO_NATIONAL(DIPPLIN),
    WOHNET_TO_NATIONAL(HYDRAPPLE),
    WOHNET_TO_NATIONAL(FLABEBE),
    WOHNET_TO_NATIONAL(FLOETTE),
    WOHNET_TO_NATIONAL(FLORGES),
    WOHNET_TO_NATIONAL(IGGLYBUFF),
    WOHNET_TO_NATIONAL(JIGGLYPUFF),
    WOHNET_TO_NATIONAL(WIGGLYTUFF),
    WOHNET_TO_NATIONAL(BUDEW),
    WOHNET_TO_NATIONAL(ROSELIA),
    WOHNET_TO_NATIONAL(ROSERADE),
    WOHNET_TO_NATIONAL(CUTIEFLY),
    WOHNET_TO_NATIONAL(RIBOMBEE),
    WOHNET_TO_NATIONAL(COMBEE),
    WOHNET_TO_NATIONAL(VESPIQUEN),
    WOHNET_TO_NATIONAL(RALTS),
    WOHNET_TO_NATIONAL(KIRLIA),
    WOHNET_TO_NATIONAL(GARDEVOIR),
    WOHNET_TO_NATIONAL(GALLADE),
    WOHNET_TO_NATIONAL(TOGEPI),
    WOHNET_TO_NATIONAL(TOGETIC),
    WOHNET_TO_NATIONAL(TOGEKISS),
    WOHNET_TO_NATIONAL(AUDINO),
    WOHNET_TO_NATIONAL(SMEARGLE),
    WOHNET_TO_NATIONAL(DODUO),
    WOHNET_TO_NATIONAL(DODRIO),
    WOHNET_TO_NATIONAL(COTTONEE),
    WOHNET_TO_NATIONAL(WHIMSICOTT),
    WOHNET_TO_NATIONAL(VENONAT),
    WOHNET_TO_NATIONAL(VENOMOTH),
    WOHNET_TO_NATIONAL(KOFFING),
    WOHNET_TO_NATIONAL(WEEZING),
    WOHNET_TO_NATIONAL(PONYTA),
    WOHNET_TO_NATIONAL(RAPIDASH),
    WOHNET_TO_NATIONAL(TAUROS),
    WOHNET_TO_NATIONAL(HELIOPTILE),
    WOHNET_TO_NATIONAL(HELIOLISK),
    WOHNET_TO_NATIONAL(DIGLETT),
    WOHNET_TO_NATIONAL(DUGTRIO),
    WOHNET_TO_NATIONAL(GLIGAR),
    WOHNET_TO_NATIONAL(GLISCOR),
    WOHNET_TO_NATIONAL(TRAPINCH),
    WOHNET_TO_NATIONAL(VIBRAVA),
    WOHNET_TO_NATIONAL(FLYGON),
    WOHNET_TO_NATIONAL(HIPPOPOTAS),
    WOHNET_TO_NATIONAL(HIPPOWDON),
    WOHNET_TO_NATIONAL(DWEBBLE),
    WOHNET_TO_NATIONAL(CRUSTLE),
    WOHNET_TO_NATIONAL(SCRAGGY),
    WOHNET_TO_NATIONAL(SCRAFTY),
    WOHNET_TO_NATIONAL(MARACTUS),
    WOHNET_TO_NATIONAL(DARUMAKA),
    WOHNET_TO_NATIONAL(DARMANITAN),
    WOHNET_TO_NATIONAL(ZUBAT),
    WOHNET_TO_NATIONAL(GOLBAT),
    WOHNET_TO_NATIONAL(CROBAT),
    WOHNET_TO_NATIONAL(NOIBAT),
    WOHNET_TO_NATIONAL(NOIVERN),
    WOHNET_TO_NATIONAL(WHISMUR),
    WOHNET_TO_NATIONAL(LOUDRED),
    WOHNET_TO_NATIONAL(EXPLOUD),
    WOHNET_TO_NATIONAL(SLUGMA),
    WOHNET_TO_NATIONAL(MAGCARGO),
    WOHNET_TO_NATIONAL(TORKOAL),
    WOHNET_TO_NATIONAL(LARVESTA),
    WOHNET_TO_NATIONAL(VOLCARONA),
    WOHNET_TO_NATIONAL(JOLTIK),
    WOHNET_TO_NATIONAL(GALVANTULA),
    WOHNET_TO_NATIONAL(TOXEL),
    WOHNET_TO_NATIONAL(TOXTRICITY),
    WOHNET_TO_NATIONAL(ONIX),
    WOHNET_TO_NATIONAL(STEELIX),
    WOHNET_TO_NATIONAL(ARON),
    WOHNET_TO_NATIONAL(LAIRON),
    WOHNET_TO_NATIONAL(AGGRON),
    WOHNET_TO_NATIONAL(ROGGENROLA),
    WOHNET_TO_NATIONAL(BOLDORE),
    WOHNET_TO_NATIONAL(GIGALITH),
    WOHNET_TO_NATIONAL(CARBINK),
    WOHNET_TO_NATIONAL(GLIMMET),
    WOHNET_TO_NATIONAL(GLIMMORA),
    WOHNET_TO_NATIONAL(MAWILE),
    WOHNET_TO_NATIONAL(SABLEYE),
    WOHNET_TO_NATIONAL(GOLETT),
    WOHNET_TO_NATIONAL(GOLURK),
    WOHNET_TO_NATIONAL(FERROSEED),
    WOHNET_TO_NATIONAL(FERROTHORN),
    WOHNET_TO_NATIONAL(PAWNIARD),
    WOHNET_TO_NATIONAL(BISHARP),
    WOHNET_TO_NATIONAL(KINGAMBIT),
    WOHNET_TO_NATIONAL(BIDOOF),
    WOHNET_TO_NATIONAL(BIBAREL),
    WOHNET_TO_NATIONAL(AZURILL),
    WOHNET_TO_NATIONAL(MARILL),
    WOHNET_TO_NATIONAL(AZUMARILL),
    WOHNET_TO_NATIONAL(PSYDUCK),
    WOHNET_TO_NATIONAL(GOLDUCK),
    WOHNET_TO_NATIONAL(BUIZEL),
    WOHNET_TO_NATIONAL(FLOATZEL),
    WOHNET_TO_NATIONAL(LOTAD),
    WOHNET_TO_NATIONAL(LOMBRE),
    WOHNET_TO_NATIONAL(LUDICOLO),
    WOHNET_TO_NATIONAL(GOLDEEN),
    WOHNET_TO_NATIONAL(SEAKING),
    WOHNET_TO_NATIONAL(FEEBAS),
    WOHNET_TO_NATIONAL(MILOTIC),
    WOHNET_TO_NATIONAL(SURSKIT),
    WOHNET_TO_NATIONAL(MASQUERAIN),
    WOHNET_TO_NATIONAL(DEWPIDER),
    WOHNET_TO_NATIONAL(ARAQUANID),
    WOHNET_TO_NATIONAL(TYNAMO),
    WOHNET_TO_NATIONAL(EELEKTRIK),
    WOHNET_TO_NATIONAL(EELEKTROSS),
    WOHNET_TO_NATIONAL(YANMA),
    WOHNET_TO_NATIONAL(YANMEGA),
    WOHNET_TO_NATIONAL(WOOPER),
    WOHNET_TO_NATIONAL(QUAGSIRE),
    WOHNET_TO_NATIONAL(TANGELA),
    WOHNET_TO_NATIONAL(TANGROWTH),
    WOHNET_TO_NATIONAL(GULPIN),
    WOHNET_TO_NATIONAL(SWALOT),
    WOHNET_TO_NATIONAL(CROAGUNK),
    WOHNET_TO_NATIONAL(TOXICROAK),
    WOHNET_TO_NATIONAL(STUNFISK),
    WOHNET_TO_NATIONAL(TADBULB),
    WOHNET_TO_NATIONAL(BELLIBOLT),
    WOHNET_TO_NATIONAL(WINGULL),
    WOHNET_TO_NATIONAL(PELIPPER),
    WOHNET_TO_NATIONAL(WATTREL),
    WOHNET_TO_NATIONAL(KILOWATTREL),
    WOHNET_TO_NATIONAL(SLOWPOKE),
    WOHNET_TO_NATIONAL(SLOWBRO),
    WOHNET_TO_NATIONAL(SLOWKING),
    WOHNET_TO_NATIONAL(KRABBY),
    WOHNET_TO_NATIONAL(KINGLER),
    WOHNET_TO_NATIONAL(CORPHISH),
    WOHNET_TO_NATIONAL(CRAWDAUNT),
    WOHNET_TO_NATIONAL(CRABRAWLER),
    WOHNET_TO_NATIONAL(CRABOMINABLE),
    WOHNET_TO_NATIONAL(WIMPOD),
    WOHNET_TO_NATIONAL(GOLISOPOD),
    WOHNET_TO_NATIONAL(PINCURCHIN),
    WOHNET_TO_NATIONAL(SANDYGAST),
    WOHNET_TO_NATIONAL(PALOSSAND),
    WOHNET_TO_NATIONAL(BINACLE),
    WOHNET_TO_NATIONAL(BARBARACLE),
    WOHNET_TO_NATIONAL(SPHEAL),
    WOHNET_TO_NATIONAL(SEALEO),
    WOHNET_TO_NATIONAL(WALREIN),
    WOHNET_TO_NATIONAL(HORSEA),
    WOHNET_TO_NATIONAL(SEADRA),
    WOHNET_TO_NATIONAL(KINGDRA),
    WOHNET_TO_NATIONAL(WAILMER),
    WOHNET_TO_NATIONAL(WAILORD),
    WOHNET_TO_NATIONAL(CLAMPERL),
    WOHNET_TO_NATIONAL(HUNTAIL),
    WOHNET_TO_NATIONAL(GOREBYSS),
    WOHNET_TO_NATIONAL(LUVDISC),
    WOHNET_TO_NATIONAL(BASCULIN),
    WOHNET_TO_NATIONAL(TENTACOOL),
    WOHNET_TO_NATIONAL(TENTACRUEL),
    WOHNET_TO_NATIONAL(STARYU),
    WOHNET_TO_NATIONAL(STARMIE),
    WOHNET_TO_NATIONAL(SHELLDER),
    WOHNET_TO_NATIONAL(CLOYSTER),
    WOHNET_TO_NATIONAL(CARVANHA),
    WOHNET_TO_NATIONAL(SHARPEDO),
    WOHNET_TO_NATIONAL(INKAY),
    WOHNET_TO_NATIONAL(MALAMAR),
    WOHNET_TO_NATIONAL(CLOBBOPUS),
    WOHNET_TO_NATIONAL(GRAPPLOCT),
    WOHNET_TO_NATIONAL(PORYGON),
    WOHNET_TO_NATIONAL(PORYGON2),
    WOHNET_TO_NATIONAL(PORYGON_Z),
    WOHNET_TO_NATIONAL(MAGNEMITE),
    WOHNET_TO_NATIONAL(MAGNETON),
    WOHNET_TO_NATIONAL(MAGNEZONE),
    WOHNET_TO_NATIONAL(ROTOM),
    WOHNET_TO_NATIONAL(VANILLITE),
    WOHNET_TO_NATIONAL(VANILLISH),
    WOHNET_TO_NATIONAL(VANILLUXE),
    WOHNET_TO_NATIONAL(SHUPPET),
    WOHNET_TO_NATIONAL(BANETTE),
    WOHNET_TO_NATIONAL(LITWICK),
    WOHNET_TO_NATIONAL(LAMPENT),
    WOHNET_TO_NATIONAL(CHANDELURE),
    WOHNET_TO_NATIONAL(LILEEP),
    WOHNET_TO_NATIONAL(CRADILY),
    WOHNET_TO_NATIONAL(ANORITH),
    WOHNET_TO_NATIONAL(ARMALDO),
    WOHNET_TO_NATIONAL(TYRUNT),
    WOHNET_TO_NATIONAL(TYRANTRUM),
    WOHNET_TO_NATIONAL(AMAURA),
    WOHNET_TO_NATIONAL(AURORUS),
    WOHNET_TO_NATIONAL(KECLEON),
    WOHNET_TO_NATIONAL(CASTFORM),
    WOHNET_TO_NATIONAL(DITTO),
    WOHNET_TO_NATIONAL(EEVEE),
    WOHNET_TO_NATIONAL(VAPOREON),
    WOHNET_TO_NATIONAL(JOLTEON),
    WOHNET_TO_NATIONAL(FLAREON),
    WOHNET_TO_NATIONAL(ESPEON),
    WOHNET_TO_NATIONAL(UMBREON),
    WOHNET_TO_NATIONAL(LEAFEON),
    WOHNET_TO_NATIONAL(GLACEON),
    WOHNET_TO_NATIONAL(SYLVEON),
    WOHNET_TO_NATIONAL(SNIVY),
    WOHNET_TO_NATIONAL(SERVINE),
    WOHNET_TO_NATIONAL(SERPERIOR),
    WOHNET_TO_NATIONAL(TEPIG),
    WOHNET_TO_NATIONAL(PIGNITE),
    WOHNET_TO_NATIONAL(EMBOAR),
    WOHNET_TO_NATIONAL(OSHAWOTT),
    WOHNET_TO_NATIONAL(DEWOTT),
    WOHNET_TO_NATIONAL(SAMUROTT),
    WOHNET_TO_NATIONAL(BELDUM),
    WOHNET_TO_NATIONAL(METANG),
    WOHNET_TO_NATIONAL(METAGROSS),
    WOHNET_TO_NATIONAL(LARVITAR),
    WOHNET_TO_NATIONAL(PUPITAR),
    WOHNET_TO_NATIONAL(TYRANITAR),
    WOHNET_TO_NATIONAL(AXEW),
    WOHNET_TO_NATIONAL(FRAXURE),
    WOHNET_TO_NATIONAL(HAXORUS),
    WOHNET_TO_NATIONAL(GOOMY),
    WOHNET_TO_NATIONAL(SLIGGOO),
    WOHNET_TO_NATIONAL(GOODRA),
    WOHNET_TO_NATIONAL(LATIAS),
    WOHNET_TO_NATIONAL(LATIOS),
    WOHNET_TO_NATIONAL(CELEBI),
    WOHNET_TO_NATIONAL(TORNADUS),
    WOHNET_TO_NATIONAL(THUNDURUS),
    WOHNET_TO_NATIONAL(LANDORUS),
    WOHNET_TO_NATIONAL(DIANCIE),
    WOHNET_TO_NATIONAL(MELTAN),
    WOHNET_TO_NATIONAL(MELMETAL),
    WOHNET_TO_NATIONAL(DEOXYS),
};
...
{
    return NationalToWohnetOrder(nationalNum);
}

enum WohnetDexOrder NationalToWohnetOrder(enum NationalDexOrder nationalNum)
{
    u16 regionalNum;
    ...
    while (regionalNum < (WOHNET_DEX_COUNT - 1) && sWohnetToNationalOrder[regionalNum] != nationalNum)
        regionalNum++;

    if (regionalNum >= WOHNET_DEX_COUNT - 1)
        return 0;
...
{
    return SpeciesToWohnetPokedexNum(species);
}
enum WohnetDexOrder SpeciesToWohnetPokedexNum(u16 species)
{
    if (!species)
        return 0;
    return NationalToWohnetOrder(gSpeciesInfo[species].natDexNum);
}

enum NationalDexOrder RegionalToNationalOrder(u32 regionalNum)
{
    return WohnetToNationalOrder(regionalNum);
}

enum NationalDexOrder WohnetToNationalOrder(enum WohnetDexOrder wohnetNum)
{
    if (!wohnetNum || wohnetNum >= WOHNET_DEX_COUNT)
        return 0;

    return sWohnetToNationalOrder[wohnetNum - 1];
}
...
{
    return IsSpeciesInWohnetDex(species);
}

bool32 IsSpeciesInWohnetDex(u16 species)
{
    if (SpeciesToWohnetPokedexNum(species) > WOHNET_DEX_COUNT)
        return FALSE;
    else
        return TRUE;
}
