...
{
    { .trainerId = TRAINER_NONE, .text = COMPOUND_STRING("KIRA") },
    { .trainerId = TRAINER_NONE,  .text = COMPOUND_STRING("AMY") },
    { .trainerId = TRAINER_NONE, .text = COMPOUND_STRING("JOHN") },
    { .trainerId = TRAINER_NONE, .text = COMPOUND_STRING("ROY") },
    { .trainerId = TRAINER_NONE, .text = COMPOUND_STRING("GABBY") },
    { .trainerId = TRAINER_NONE, .text = COMPOUND_STRING("ANNA") },
};
