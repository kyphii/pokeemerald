...
void CreateContestMonFromParty(u8 partyIndex)
{
    ...
    if (gSaveBlock2Ptr->playerGender == MALE)
        gContestMons[gContestPlayerMonIndex].trainerGfxId = OBJ_EVENT_GFX_PLAYER_M_NORMAL;
    else
        gContestMons[gContestPlayerMonIndex].trainerGfxId = OBJ_EVENT_GFX_PLAYER_F_NORMAL;
