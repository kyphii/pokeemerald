...
static bool32 IsRegularLandTrainer(u8 graphicsId)
{
    ...
    {
        OBJ_EVENT_GFX_NPC_ACE_TRAINER_F,
        OBJ_EVENT_GFX_NPC_ACE_TRAINER_M,
        OBJ_EVENT_GFX_NPC_ATHELETE_M,
        OBJ_EVENT_GFX_NPC_BEACHGOER,
        OBJ_EVENT_GFX_NPC_BUG_CATCHER,
        OBJ_EVENT_GFX_NPC_CAPTAIN,
        OBJ_EVENT_GFX_NPC_CHEF,
        OBJ_EVENT_GFX_NPC_CLERK_F,
        OBJ_EVENT_GFX_NPC_CLERK_M,
        OBJ_EVENT_GFX_NPC_DANCER_M,
        OBJ_EVENT_GFX_NPC_ELDER_F,
        OBJ_EVENT_GFX_NPC_ELDER_M,
        OBJ_EVENT_GFX_NPC_EXECUTIVE,
        OBJ_EVENT_GFX_NPC_FAIRY_GIRL,
        OBJ_EVENT_GFX_NPC_FASHIONISTA,
        OBJ_EVENT_GFX_NPC_FAT_MAN,
        OBJ_EVENT_GFX_NPC_FIGHTER_F,
        OBJ_EVENT_GFX_NPC_FIGHTER_M,
        OBJ_EVENT_GFX_NPC_FISHER,
        OBJ_EVENT_GFX_NPC_GARDENER,
        OBJ_EVENT_GFX_NPC_GENTLEMAN,
        OBJ_EVENT_GFX_NPC_GUARD,
        OBJ_EVENT_GFX_NPC_HIKER,
        OBJ_EVENT_GFX_NPC_MAN_1,
        OBJ_EVENT_GFX_NPC_MAN_2,
        OBJ_EVENT_GFX_NPC_MAN_3,
        OBJ_EVENT_GFX_NPC_MYSTIC,
        OBJ_EVENT_GFX_NPC_NERD_M,
        OBJ_EVENT_GFX_NPC_NURSE,
        OBJ_EVENT_GFX_NPC_OCCULTIST,
        OBJ_EVENT_GFX_NPC_SAGE_M,
        OBJ_EVENT_GFX_NPC_SAILOR,
        OBJ_EVENT_GFX_NPC_SCHOOL_BOY,
        OBJ_EVENT_GFX_NPC_SCHOOL_GIRL,
        OBJ_EVENT_GFX_NPC_SCIENTIST_F,
        OBJ_EVENT_GFX_NPC_SCIENTIST_M,
        OBJ_EVENT_GFX_NPC_SCOUT_F,
        OBJ_EVENT_GFX_NPC_SCOUT_M,
        OBJ_EVENT_GFX_NPC_SKIER_F,
        OBJ_EVENT_GFX_NPC_SKIER_M,
        OBJ_EVENT_GFX_NPC_SHOPKEEPER,
        OBJ_EVENT_GFX_NPC_STEWARDESS,
        OBJ_EVENT_GFX_NPC_STUDENT_M,
        OBJ_EVENT_GFX_NPC_SWIMMER_LAND_M,
        OBJ_EVENT_GFX_NPC_TUBER_LAND_F,
        OBJ_EVENT_GFX_NPC_TUBER_LAND_M,
        OBJ_EVENT_GFX_NPC_TYKE_F,
        OBJ_EVENT_GFX_NPC_TYKE_M,
        OBJ_EVENT_GFX_NPC_WOMAN_1,
        OBJ_EVENT_GFX_NPC_WORKER,
    };
...
static bool32 IsRegularWaterTrainer(u8 graphicsId)
{
    ...
    {
        OBJ_EVENT_GFX_NPC_SWIMMER_WATER_F,
        OBJ_EVENT_GFX_NPC_SWIMMER_WATER_M,
        OBJ_EVENT_GFX_NPC_TUBER_WATER_M,
    };
