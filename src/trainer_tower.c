...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    {OBJ_EVENT_GFX_KYPHII,     FACILITY_CLASS_HEX_MANIAC,          MALE},
    {OBJ_EVENT_GFX_KYPHII,            FACILITY_CLASS_RICH_BOY,            MALE},
    {OBJ_EVENT_GFX_KYPHII,         FACILITY_CLASS_GUITARIST,           MALE},
    {OBJ_EVENT_GFX_KYPHII,         FACILITY_CLASS_KINDLER,             MALE},
    {OBJ_EVENT_GFX_KYPHII,     FACILITY_CLASS_BUG_MANIAC,          MALE},
    {OBJ_EVENT_GFX_KYPHII,            FACILITY_CLASS_SCHOOL_KID_M,        MALE},
    {OBJ_EVENT_GFX_KYPHII,   FACILITY_CLASS_SCHOOL_KID_F,      FEMALE},
    {OBJ_EVENT_GFX_KYPHII,    FACILITY_CLASS_POKEFAN_M,           MALE},
    {OBJ_EVENT_GFX_KYPHII,   FACILITY_CLASS_POKEFAN_F,         FEMALE},
    {OBJ_EVENT_GFX_KYPHII,      FACILITY_CLASS_EXPERT_M,            MALE},
    {OBJ_EVENT_GFX_KYPHII, FACILITY_CLASS_EXPERT_F,          FEMALE},
    {OBJ_EVENT_GFX_KYPHII,  FACILITY_CLASS_DRAGON_TAMER,        MALE},
    {OBJ_EVENT_GFX_KYPHII, FACILITY_CLASS_NINJA_BOY,           MALE},
    {OBJ_EVENT_GFX_KYPHII,    FACILITY_CLASS_BATTLE_GIRL,       FEMALE},
    {OBJ_EVENT_GFX_KYPHII,    FACILITY_CLASS_PARASOL_LADY,      FEMALE},
    {OBJ_EVENT_GFX_KYPHII,   FACILITY_CLASS_COLLECTOR,           MALE},
    {OBJ_EVENT_GFX_KYPHII, FACILITY_CLASS_YOUNGSTER_FRLG,           MALE},
    {OBJ_EVENT_GFX_KYPHII, FACILITY_CLASS_BUG_CATCHER_FRLG,         MALE},
    {OBJ_EVENT_GFX_KYPHII,      FACILITY_CLASS_LASS_FRLG,              FEMALE},
    {OBJ_EVENT_GFX_KYPHII,    FACILITY_CLASS_SAILOR_FRLG,              MALE},
    {OBJ_EVENT_GFX_KYPHII,    FACILITY_CLASS_CAMPER_FRLG,              MALE},
    {OBJ_EVENT_GFX_KYPHII, FACILITY_CLASS_PICNICKER_FRLG,         FEMALE},
    {OBJ_EVENT_GFX_KYPHII,     FACILITY_CLASS_POKEMANIAC,          MALE},
    {OBJ_EVENT_GFX_KYPHII,     FACILITY_CLASS_SUPER_NERD_FRLG,          MALE},
    {OBJ_EVENT_GFX_KYPHII,     FACILITY_CLASS_HIKER_FRLG,               MALE},
    {OBJ_EVENT_GFX_KYPHII,          FACILITY_CLASS_BIKER_FRLG,               MALE},
    {OBJ_EVENT_GFX_KYPHII,     FACILITY_CLASS_BURGLAR_FRLG,             MALE},
    {OBJ_EVENT_GFX_KYPHII,    FACILITY_CLASS_ENGINEER_FRLG,            MALE},
    {OBJ_EVENT_GFX_KYPHII,         FACILITY_CLASS_FISHERMAN_FRLG,           MALE},
    {OBJ_EVENT_GFX_KYPHII, FACILITY_CLASS_SWIMMER_M_FRLG,           MALE},
    {OBJ_EVENT_GFX_KYPHII,          FACILITY_CLASS_CUE_BALL_FRLG,            MALE},
    {OBJ_EVENT_GFX_KYPHII,    FACILITY_CLASS_BEAUTY_FRLG,            FEMALE},
    {OBJ_EVENT_GFX_KYPHII, FACILITY_CLASS_SWIMMER_F_FRLG,         FEMALE},
    {OBJ_EVENT_GFX_KYPHII,            FACILITY_CLASS_PSYCHIC_M_FRLG,           MALE},
    {OBJ_EVENT_GFX_KYPHII,         FACILITY_CLASS_ROCKER_FRLG,              MALE},
    {OBJ_EVENT_GFX_KYPHII,         FACILITY_CLASS_JUGGLER_FRLG,             MALE},
    {OBJ_EVENT_GFX_KYPHII,         FACILITY_CLASS_BIRD_KEEPER,         MALE},
    {OBJ_EVENT_GFX_KYPHII,      FACILITY_CLASS_BLACK_BELT_FRLG,          MALE},
    {OBJ_EVENT_GFX_KYPHII,      FACILITY_CLASS_SCIENTIST_FRLG,           MALE},
    {OBJ_EVENT_GFX_KYPHII,  FACILITY_CLASS_COOLTRAINER_M_FRLG,       MALE},
    {OBJ_EVENT_GFX_KYPHII,  FACILITY_CLASS_COOLTRAINER_F_FRLG,     FEMALE},
    {OBJ_EVENT_GFX_KYPHII,      FACILITY_CLASS_GENTLEMAN_FRLG,           MALE},
    {OBJ_EVENT_GFX_KYPHII,   FACILITY_CLASS_PSYCHIC_F_FRLG,         FEMALE},
    {OBJ_EVENT_GFX_KYPHII,    FACILITY_CLASS_CRUSH_GIRL_FRLG,        FEMALE},
    {OBJ_EVENT_GFX_KYPHII,   FACILITY_CLASS_TUBER_FRLG,             FEMALE},
    {OBJ_EVENT_GFX_KYPHII,   FACILITY_CLASS_PKMN_BREEDER_FRLG,      FEMALE},
    {OBJ_EVENT_GFX_KYPHII,    FACILITY_CLASS_PKMN_RANGER_M_FRLG,       MALE},
    {OBJ_EVENT_GFX_KYPHII, FACILITY_CLASS_PKMN_RANGER_F_FRLG,     FEMALE},
    {OBJ_EVENT_GFX_KYPHII,   FACILITY_CLASS_AROMA_LADY_FRLG,        FEMALE},
    {OBJ_EVENT_GFX_KYPHII,     FACILITY_CLASS_RUIN_MANIAC,         MALE},
    {OBJ_EVENT_GFX_KYPHII,   FACILITY_CLASS_LADY_FRLG,              FEMALE}
};

static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    {OBJ_EVENT_GFX_KYPHII,    OBJ_EVENT_GFX_KYPHII,   FACILITY_CLASS_SR_AND_JR,       FEMALE, FEMALE},
    {OBJ_EVENT_GFX_KYPHII,      OBJ_EVENT_GFX_KYPHII, FACILITY_CLASS_OLD_COUPLE,        MALE, FEMALE},
    {OBJ_EVENT_GFX_KYPHII, OBJ_EVENT_GFX_KYPHII,    FACILITY_CLASS_TWINS_FRLG,           FEMALE, FEMALE},
    {OBJ_EVENT_GFX_KYPHII,  OBJ_EVENT_GFX_KYPHII,  FACILITY_CLASS_COOL_COUPLE_FRLG,       MALE, FEMALE},
    {OBJ_EVENT_GFX_KYPHII,    OBJ_EVENT_GFX_KYPHII,            FACILITY_CLASS_YOUNG_COUPLE_FRLG,    FEMALE,   MALE},
    {OBJ_EVENT_GFX_KYPHII,    OBJ_EVENT_GFX_KYPHII,      FACILITY_CLASS_CRUSH_KIN_FRLG,       FEMALE,   MALE},
    {OBJ_EVENT_GFX_KYPHII, OBJ_EVENT_GFX_KYPHII,   FACILITY_CLASS_SIS_AND_BRO_FRLG,     FEMALE,   MALE}
};
...
static const struct TrainerEncounterMusicPairs sTrainerEncounterMusicLUT[] = {
    ...
    {FACILITY_CLASS_LEADER_LANDON,         TRAINER_ENCOUNTER_MUSIC_TWINS},
...
static const u16 sTrainerTowerEncounterMusic[] = {
    ...
    [TRAINER_ENCOUNTER_MUSIC_FEMALE]      = MUS_ENCOUNTER_MALE,
    [TRAINER_ENCOUNTER_MUSIC_GIRL]        = MUS_ENCOUNTER_MALE,
    [TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS]  = MUS_ENCOUNTER_MALE,
    [TRAINER_ENCOUNTER_MUSIC_INTENSE]     = MUS_ENCOUNTER_MALE,
    [TRAINER_ENCOUNTER_MUSIC_COOL]        = MUS_ENCOUNTER_MALE,
    [TRAINER_ENCOUNTER_MUSIC_AQUA]        = MUS_ENCOUNTER_MALE,
    [TRAINER_ENCOUNTER_MUSIC_MAGMA]       = MUS_ENCOUNTER_MALE,
    [TRAINER_ENCOUNTER_MUSIC_SWIMMER]     = MUS_ENCOUNTER_MALE,
    [TRAINER_ENCOUNTER_MUSIC_TWINS]       = MUS_ENCOUNTER_MALE,
    [TRAINER_ENCOUNTER_MUSIC_ELITE_FOUR]  = MUS_ENCOUNTER_MALE,
    [TRAINER_ENCOUNTER_MUSIC_HIKER]       = MUS_ENCOUNTER_MALE,
    [TRAINER_ENCOUNTER_MUSIC_INTERVIEWER] = MUS_ENCOUNTER_MALE,
    [TRAINER_ENCOUNTER_MUSIC_RICH]        = MUS_ENCOUNTER_MALE
};
...
static void SetTrainerTowerNPCGraphics(void)
{
    ...
    case CHALLENGE_TYPE_SINGLE:
        ...
        if (i != NELEMS(sSingleBattleTrainerInfo))
            ...
            trainerGfx1 = OBJ_EVENT_GFX_KYPHII;
    ...
    case CHALLENGE_TYPE_DOUBLE:
        ...
        {
            trainerGfx1  = OBJ_EVENT_GFX_KYPHII;
            trainerGfx2 = OBJ_EVENT_GFX_KYPHII;
        }
