...
const u8 gText_ExpShareOn[] = _("The Exp. All has been turned on.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpShareOff[] = _("The Exp. All has been turned off.{PAUSE_UNTIL_PRESS}");
