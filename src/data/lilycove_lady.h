...
{
    [LILYCOVE_LADY_QUIZ]    = OBJ_EVENT_GFX_KYPHII,
    [LILYCOVE_LADY_FAVOR]   = OBJ_EVENT_GFX_KYPHII,
    [LILYCOVE_LADY_CONTEST] = OBJ_EVENT_GFX_KYPHII,
};
