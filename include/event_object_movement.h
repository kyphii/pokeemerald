...
void MovementType_Path(struct Sprite* sprite);
...
u8 MovementType_Path_Step0(struct ObjectEvent* objectEvent, struct Sprite* sprite);
u8 MovementType_Path_Step1(struct ObjectEvent* objectEvent, struct Sprite* sprite);
u8 MovementType_Path_Step2(struct ObjectEvent* objectEvent, struct Sprite* sprite);
u8 MovementType_Path_Step3(struct ObjectEvent* objectEvent, struct Sprite* sprite);
