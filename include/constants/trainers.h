...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_MAYA,
    TRAINER_PIC_FRONT_PROTAG_M,
    TRAINER_PIC_FRONT_PROTAG_F,
    TRAINER_PIC_FRONT_LEADER_LANDON,
    ...
    TRAINER_PIC_FRONT_SKIER_F,
    TRAINER_PIC_FRONT_SKIER_M,
    ...
    TRAINER_PIC_BACK_MAYA,
    TRAINER_PIC_BACK_OLD_MAN,
    TRAINER_PIC_COUNT,
    TRAINER_PIC_BACK_COUNT = (TRAINER_PIC_COUNT - TRAINER_PIC_FRONT_COUNT),
};

#define TRAINER_BACK_PIC_PLAYER_MALE (TRAINER_PIC_BACK_BRENDAN)
#define TRAINER_BACK_PIC_PLAYER_FEMALE (TRAINER_PIC_BACK_MAY)
...
#define FACILITY_CLASS_LEADER_LANDON        0x23
...
#define FACILITY_CLASS_SKIER_F               0x77
#define FACILITY_CLASS_SKIER_M               0x78
