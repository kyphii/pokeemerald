...
enum {
    ...
    METATILE_LAYER_TYPE_HALF_COVERED, // Metatile uses all bg layers, with high tiles split vertically between top and middle
    METATILE_LAYER_TYPE_DOOR,       // Only draw to bottom bg layer (used by doors)
};
