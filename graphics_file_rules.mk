...
$(TILESETGFXDIR)/secondary/nautirust/tiles.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -num_tiles 498 -Wnum_tiles

$(TILESETGFXDIR)/secondary/whelchord/tiles.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -num_tiles 328 -Wnum_tiles

$(TILESETGFXDIR)/secondary/armiter/tiles.4bpp: %.4bpp: %.png
...
$(TILESETGFXDIR)/secondary/quaheart/tiles.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -num_tiles 448 -Wnum_tiles
	
$(TILESETGFXDIR)/secondary/periwind/tiles.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -num_tiles 448 -Wnum_tiles

$(TILESETGFXDIR)/secondary/volutide/tiles.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -num_tiles 448 -Wnum_tiles

$(TILESETGFXDIR)/secondary/gardellin/tiles.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -num_tiles 450 -Wnum_tiles

$(TILESETGFXDIR)/secondary/abalove/tiles.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -num_tiles 504 -Wnum_tiles

$(TILESETGFXDIR)/secondary/snowrie/tiles.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -num_tiles 504 -Wnum_tiles
...
$(TILESETGFXDIR)/secondary/desert_sanctuary_museum/tiles.4bpp: %.4bpp: %.png
...
$(TILESETGFXDIR)/secondary/nautirust_gym/tiles.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -num_tiles 60 -Wnum_tiles

$(TILESETGFXDIR)/secondary/whelchord_gym/tiles.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -num_tiles 60 -Wnum_tiles

$(TILESETGFXDIR)/secondary/armiter_gym/tiles.4bpp: %.4bpp: %.png
...
$(TILESETGFXDIR)/secondary/quaheart_gym/tiles.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -num_tiles 61 -Wnum_tiles

$(TILESETGFXDIR)/secondary/periwind_gym/tiles.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -num_tiles 61 -Wnum_tiles
